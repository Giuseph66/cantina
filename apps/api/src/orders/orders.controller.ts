...
export class OrdersController {
    ...
    getPublicOrder(@Param('id') id: string) {
        return this.ordersService.getPublicOrderById(id);
    }

    @Post('orders/public/:id/report-paid')
    reportPublicOrderPaid(@Param('id') id: string) {
        return this.ordersService.reportPublicOrderPaid(id);
    }
